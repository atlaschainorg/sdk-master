...
//!
//! Time in Atlas is marked primarily by _slots_, which occur approximately every
...
//!
//! [oracle]: https://docs.atlaslabs.com/implemented-proposals/validator-timestamp-oracle
#![no_std]
...
pub struct Clock {
    ...
    ///
    /// [tsc]: https://docs.atlaslabs.com/implemented-proposals/bank-timestamp-correction
    /// [oracle]: https://docs.atlaslabs.com/implemented-proposals/validator-timestamp-oracle
