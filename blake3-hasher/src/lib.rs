...
pub use atlas_hash::{Hash, ParseHashError, HASH_BYTES, MAX_BASE58_LEN};

#[derive(Clone, Default)]
#[cfg(all(feature = "blake3", not(target_os = "atlas")))]
pub struct Hasher {
...
pub fn hashv(vals: &[&[u8]]) -> Hash {
    ...
    #[cfg(not(target_os = "atlas"))]
    {
        ...
        #[cfg(not(feature = "blake3"))]
        {
            ...
            panic!("hashv is only available on target `atlas` or with the `blake3` feature enabled on this crate")
        }
    }
    ...
    #[cfg(target_os = "atlas")]
    {
        ...
        unsafe {
            atlas_define_syscall::definitions::sol_blake3(
