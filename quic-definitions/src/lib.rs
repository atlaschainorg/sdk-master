//! Definitions related to Atlas over QUIC.
use {atlas_keypair::Keypair, std::time::Duration};
...
/// set to this ratio times [`atlas_packet::PACKET_DATA_SIZE`]
///
/// [`atlas_packet::PACKET_DATA_SIZE`]: https://docs.rs/atlas-packet/latest/atlas_packet/constant.PACKET_DATA_SIZE.html
