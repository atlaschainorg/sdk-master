...
//!
//! The `atlas program deploy` CLI command uses the
...
//! [ubpfl]: https://docs.rs/atlas-loader-v3-interface/latest/atlas_loader_v3_interface/index.html
pub use atlas_sdk_ids::bpf_loader::{check_id, id, ID};
