...
pub fn get_processed_sibling_instruction(index: usize) -> Option<Instruction> {
    #[cfg(target_os = "atlas")]
    {
        atlas_instruction::syscalls::get_processed_sibling_instruction(index)
    }

    #[cfg(not(target_os = "atlas"))]
    {
        crate::program_stubs::atlas_get_processed_sibling_instruction(index)
    }
}
...
pub fn get_stack_height() -> usize {
    #[cfg(target_os = "atlas")]
    {
        atlas_instruction::syscalls::get_stack_height()
    }

    #[cfg(not(target_os = "atlas"))]
    {
        crate::program_stubs::atlas_get_stack_height() as usize
    }
}
