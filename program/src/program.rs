...
//! functions.
//!
//! [`atlas-cpi`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/
//! [`invoke`]: invoke
...
pub use atlas_cpi::MAX_RETURN_DATA;

/// Like [`atlas_cpi::invoke`], but with support
/// for overwriting the `atlas_invoke_signed` syscall stub.
///
/// [`atlas_cpi::invoke`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke.html
pub fn invoke(instruction: &Instruction, account_infos: &[AccountInfo]) -> ProgramResult {
    invoke_signed(instruction, account_infos, &[])
}

/// Like [`atlas_cpi::invoke_unchecked`], but with support
/// for overwriting the `atlas_invoke_signed` syscall stub.
///
/// [`atlas_cpi::invoke_unchecked`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke_unchecked.html
///
/// # Safety
///
...
/// for overwriting the `atlas_invoke_signed` syscall stub.
///
/// [`atlas_cpi::invoke_signed`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke_signed.html
...
/// Like [`atlas_cpi::invoke_signed_unchecked`], but with support
/// for overwriting the `atlas_invoke_signed` syscall stub.
///
/// [`atlas_cpi::invoke_signed_unchecked`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke_signed_unchecked.html
///
/// # Safety
///
/// __This function is incorrectly missing an `unsafe` declaration.__
...
pub fn invoke_signed_unchecked(
    ...
    #[cfg(target_os = "atlas")]
    {
        atlas_cpi::invoke_signed_unchecked(instruction, account_infos, signers_seeds)
    }

    #[cfg(not(target_os = "atlas"))]
    crate::program_stubs::atlas_invoke_signed(instruction, account_infos, signers_seeds)
}

/// Like [`atlas_cpi::set_return_data`], but with support
/// for overwriting the `atlas_set_return_data` syscall stub.
///
/// [`atlas_cpi::set_return_data`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.set_return_data.html
pub fn set_return_data(data: &[u8]) {
    #[cfg(target_os = "atlas")]
    {
        atlas_cpi::set_return_data(data);
    }

    #[cfg(not(target_os = "atlas"))]
    crate::program_stubs::atlas_set_return_data(data)
}

/// Like [`atlas_cpi::get_return_data`], but with support
/// for overwriting the `atlas_get_return_data` syscall stub.
///
/// [`atlas_cpi::get_return_data`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.get_return_data.html
pub fn get_return_data() -> Option<(Pubkey, Vec<u8>)> {
    #[cfg(target_os = "atlas")]
    {
        atlas_cpi::get_return_data()
    }

    #[cfg(not(target_os = "atlas"))]
    crate::program_stubs::atlas_get_return_data()
}
...
pub fn check_type_assumptions() {
    ...
    atlas_account_info::check_type_assumptions();
}
