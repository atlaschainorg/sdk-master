...
//!
//! [rent]: https://docs.atlaslabs.com/implemented-proposals/rent
//!
...
//!
//! See also the Atlas [documentation on the rent sysvar][sdoc].
//!
//! [sdoc]: https://docs.atlaslabs.com/runtime/sysvars#rent
//!
//! # Examples
//!
...
pub use {
    atlas_rent::Rent,
    atlas_sdk_ids::sysvar::rent::{check_id, id, ID},
};
impl Sysvar for Rent {
    impl_sysvar_get!(atlas_get_rent_sysvar);
}
