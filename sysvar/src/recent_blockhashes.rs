...
//!
//! [`getFeeForMessage`]: https://atlaschain.org/docs/rpc/http/getfeeformessage
//! [ccf]: https://docs.atlaslabs.com/proposals/comprehensive-compute-fees
//!
//! See also the Atlas [documentation on the recent blockhashes sysvar][sdoc].
//!
//! [sdoc]: https://docs.atlaslabs.com/runtime/sysvars#recentblockhashes
...
pub use atlas_sdk_ids::sysvar::recent_blockhashes::{check_id, id, ID};
use {
    crate::Sysvar,
    atlas_fee_calculator::FeeCalculator,
    atlas_hash::Hash,
    atlas_sysvar_id::impl_sysvar_id,
...
#[cfg(test)]
mod tests {
    use {super::*, atlas_clock::MAX_PROCESSING_AGE};
