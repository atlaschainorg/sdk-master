...
use atlas_frozen_abi_macro::{AbiEnumVisitor, AbiExample};
#[cfg(feature = "frozen-abi")]
extern crate std;
pub use atlas_program_error::{
...
use {core::fmt, atlas_program_error::ProgramError};
...
pub enum InstructionError {
    ...
    /// by the Atlas runtime. A program-specific error may be any type that is represented as
    ...
    fn from(error: T) -> Self {
        ...
        match error {
            ...
            _ => {
                ...
                if error >> atlas_program_error::BUILTIN_BIT_SHIFT == 0 {
