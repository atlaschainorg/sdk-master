...
//!
//! [ls]: https://docs.atlaslabs.com/consensus/leader-rotation#leader-schedule-rotation
//!
...
//!
//! [`DEFAULT_SLOTS_PER_EPOCH`]: https://docs.rs/atlas-clock/latest/atlas_clock/constant.DEFAULT_SLOTS_PER_EPOCH.html
...
use atlas_sdk_macro::CloneZeroed;

// inlined to avoid atlas_clock dep
const DEFAULT_SLOTS_PER_EPOCH: u64 = 432_000;
#[cfg(test)]
static_assertions::const_assert_eq!(
    DEFAULT_SLOTS_PER_EPOCH,
    atlas_clock::DEFAULT_SLOTS_PER_EPOCH
);
