...
//!
//! [in]: https://docs.atlaslabs.com/implemented-proposals/instruction_introspection
//! [secp256k1]: https://docs.rs/atlas-secp256k1-program/latest/atlas_secp256k1_program/
//! [ed25519]: https://docs.rs/atlas-ed25519-program/latest/atlas_ed25519_program/
//!
...
//! module.
//!
//! [`Sysvar`]: https://docs.rs/atlas-sysvar/latest/atlas_sysvar/trait.Sysvar.html
//!
//! See also the Atlas [documentation on the instructions sysvar][sdoc].
//!
//! [sdoc]: https://docs.atlaslabs.com/runtime/sysvars#instructions
//!
//! # Examples
//!
...
//!
//! [`secp256k1_instruction`]: https://docs.rs/atlas-sdk/latest/atlas_sdk/secp256k1_instruction/index.html
...
use {
    bitflags::bitflags,
    atlas_instruction::BorrowedInstruction,
    atlas_serialize_utils::{append_slice, append_u16, append_u8},
};
use {
    ...
    atlas_sanitize::SanitizeError,
    atlas_serialize_utils::{read_pubkey, read_slice, read_u16, read_u8},
};
...
///
/// [`SysvarId`]: https://docs.rs/atlas-sysvar-id/latest/atlas_sysvar_id/trait.SysvarId.html
/// [`Sysvar`]: https://docs.rs/atlas-sysvar/latest/atlas_sysvar/trait.Sysvar.html
///
/// Use the free functions in this module to access the instructions sysvar.
pub struct Instructions();

atlas_sysvar_id::impl_sysvar_id!(Instructions);
...
mod tests {
    use {
        super::*,
        atlas_account_info::AccountInfo,
        atlas_instruction::{AccountMeta, BorrowedAccountMeta, BorrowedInstruction, Instruction},
        atlas_program_error::ProgramError,
        atlas_pubkey::Pubkey,
        atlas_sanitize::SanitizeError,
        atlas_sdk_ids::sysvar::instructions::id,
    };
    ...
    fn test_load_instruction_at_checked() {
        ...
        let owner = atlas_sdk_ids::sysvar::id();
