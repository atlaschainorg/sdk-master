...
use {
    ...
    rand::rngs::OsRng,
    atlas_seed_phrase::generate_seed_from_seed_phrase_and_passphrase,
    atlas_signer::SignerError,
    std::{
        error,
        io::{Read, Write},
        path::Path,
...
pub use {
    atlas_pubkey::Pubkey,
    atlas_signature::{error::Error as SignatureError, Signature},
    atlas_signer::{EncodableKey, EncodableKeypair, Signer},
};
