...
//!
//! While `secp256k1_recover` can be used to verify secp256k1 signatures, Atlas
//! also provides the [secp256k1 program][sp], which is more flexible, has lower CPU
//! cost, and can validate many signatures at once.
//!
//! [sp]: https://docs.rs/atlas-program/latest/atlas_program/secp256k1_program/
...
#[cfg(target_os = "atlas")]
pub use atlas_define_syscall::definitions::sol_secp256k1_recover;
...
///
/// [`keccak`]: https://docs.rs/atlas-program/latest/atlas_program/keccak/
...
/// comparing the recovered key against an expected key, Atlas also provides
...
/// # use atlas_program::program_error::ProgramError;
/// # let signature_bytes = [
...
/// signature with the `secp256k1_recover` syscall. It has three parts: an Atlas
...
/// ```
///
/// The Atlas program. Note that it uses `k256` version 0.13.0 to parse
...
/// };
/// use atlas_secp256k1_recover::secp256k1_recover;
///
/// # pub struct DemoSecp256k1RecoverInstruction {
/// #     pub message: Vec<u8>,
/// #     pub signature: [u8; 64],
...
///
/// ```rust
/// # use atlas_program::example_mocks::atlas_rpc_client;
/// # use atlas_program::example_mocks::atlas_sdk;
/// use anyhow::Result;
