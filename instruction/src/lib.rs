...
#[cfg(any(feature = "syscalls", target_os = "atlas"))]
pub mod syscalls;
...
/// or more instructions are included in transactions submitted by Atlas
...
/// construction.
///
/// While Atlas is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Atlas runtime coalesces all accounts used
...
/// when calling the `atlas_get_processed_sibling_instruction` syscall.
#[repr(C)]
