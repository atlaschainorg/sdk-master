...
pub use atlas_address::bytes_are_curve_point;
#[cfg(target_os = "atlas")]
pub use atlas_address::syscalls;
pub use atlas_address::{
    address as pubkey,
...
/// use std::str::FromStr;
/// use atlas_pubkey::{declare_id, Pubkey};
///
/// # mod item_wrapper {
/// #   use atlas_pubkey::declare_id;
