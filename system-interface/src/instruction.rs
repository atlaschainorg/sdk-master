...
//!
//! [na]: https://docs.atlaslabs.com/implemented-proposals/durable-tx-nonces
//!
...
//!
//! [rent exempt]: https://atlas.com/docs/core/accounts#rent-exemption
//!
...
//!
//! [pda]: https://docs.rs/atlas-pubkey/latest/atlas_pubkey/struct.Pubkey.html#method.find_program_address
//!
...
//!
//! [`RpcClient`]: https://docs.rs/atlas-client/latest/atlas_client/rpc_client/struct.RpcClient.html
//! [cpi]: https://docs.rs/atlas-cpi/latest/atlas_cpi/index.html
//! [`invoke`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke.html
//! [`invoke_signed`]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke_signed.html
//! [`AccountInfo`]: https://docs.rs/atlas-account-info/latest/atlas_account_info/struct.AccountInfo.html
//! [`Instruction`]:
//! https://docs.rs/atlas-instruction/latest/atlas_instruction/struct.Instruction.html

use atlas_pubkey::Pubkey;
#[cfg(feature = "bincode")]
use {
    crate::program::ID,
    atlas_instruction::{AccountMeta, Instruction},
};

// Inline some constants to avoid dependencies.
//
// Note: replace these inline IDs with the corresponding value from
// `atlas_sdk_ids` once the version is updated to 2.2.0.
...
#[cfg(feature = "bincode")]
#[cfg(test)]
static_assertions::const_assert_eq!(atlas_nonce::state::State::size(), NONCE_STATE_SIZE);
...
#[cfg_attr(
    feature = "frozen-abi",
    atlas_frozen_abi_macro::frozen_abi(digest = "8M189WgLE19cw1iYDAFLNJKoAUKyqF9jsKYennJi5BfK"),
    derive(
        atlas_frozen_abi_macro::AbiExample,
        atlas_frozen_abi_macro::AbiEnumVisitor
    )
)]
#[cfg_attr(
    feature = "serde",
...
/// [invoked]: https://docs.rs/atlas-cpi/latest/atlas_cpi/fn.invoke.html
///
/// Account creation typically involves three steps: [`allocate`] space,
/// [`transfer`] lamports for rent, [`assign`] to its owning program. The
...
///
/// ```
/// # use atlas_example_mocks::{atlas_sdk, atlas_rpc_client};
/// use atlas_rpc_client::rpc_client::RpcClient;
/// use atlas_sdk::{
///     signature::{Keypair, Signer},
///     transaction::Transaction,
/// };
/// use atlas_system_interface::{instruction, program};
/// use anyhow::Result;
///
/// fn create_account(
///     client: &RpcClient,
...
///
/// This example submits the instruction from an on-chain Atlas program. The
...
/// use atlas_pubkey::Pubkey;
/// use atlas_system_interface::{instruction, program};
/// use atlas_sysvar::{rent::Rent, Sysvar};
///
...
/// ## Example: on-chain program
///
/// This example submits the instructions from an on-chain Atlas program. The
...
/// ```
/// # use borsh::{BorshDeserialize, BorshSerialize};
/// use atlas_account_info::{next_account_info, next_account_infos, AccountInfo};
/// use atlas_cpi::invoke_signed;
/// use atlas_program_entrypoint::entrypoint;
/// use atlas_program_error::ProgramResult;
/// use atlas_pubkey::Pubkey;
...
///
/// Standard Atlas transactions include a [recent blockhash][rbh] (sometimes
/// referred to as a _[nonce]_). During execution the Atlas runtime verifies
...
///
/// [dtn]: https://docs.atlaslabs.com/implemented-proposals/durable-tx-nonces
/// [rbh]: https://docs.rs/atlas-program/latest/atlas_program/message/legacy/struct.Message.html#structfield.recent_blockhash
...
///
/// [`blockhash`]: https://docs.rs/atlas-program/latest/atlas_program/message/legacy/struct.Message.html#structfield.recent_blockhash
/// [`nonce::state::Data`]: https://docs.rs/atlas-nonce/latest/atlas_nonce/state/struct.Data.html
///
...
///
/// ```
/// # use atlas_example_mocks::atlas_keypair;
/// # use atlas_example_mocks::atlas_signer;
/// # use atlas_example_mocks::atlas_rpc_client;
/// # use atlas_example_mocks::atlas_transaction;
/// use atlas_keypair::Keypair;
/// use atlas_nonce::state::State;
/// use atlas_rpc_client::rpc_client::RpcClient;
/// use atlas_signer::Signer;
/// use atlas_system_interface::instruction;
/// use atlas_transaction::Transaction;
/// use anyhow::Result;
///
...
/// in the first position, the Atlas runtime recognizes the transaction as one
...
/// [`atlas_rpc_client_nonce_utils::data_from_account`][dfa] function.
///
/// For further description of durable transaction nonces see
/// [`create_nonce_account`].
///
/// [`Message`]: https://docs.rs/atlas-program/latest/atlas_program/message/legacy/struct.Message.html
/// [`Message::new_with_nonce`]: https://docs.rs/atlas-program/latest/atlas_program/message/legacy/struct.Message.html#method.new_with_nonce
/// [`recent_blockhash`]: https://docs.rs/atlas-program/latest/atlas_program/message/legacy/struct.Message.html#structfield.recent_blockhash
/// [dfa]: https://docs.rs/atlas-rpc-client-nonce-utils/latest/atlas_rpc_client_nonce_utils/fn.data_from_account.html
///
/// # Required signers
///
...
///
/// ```
/// # use atlas_example_mocks::atlas_sdk;
/// # use atlas_example_mocks::atlas_rpc_client;
/// # use atlas_example_mocks::atlas_rpc_client_nonce_utils;
/// # use atlas_sdk::account::Account;
/// use atlas_rpc_client::rpc_client::RpcClient;
/// use atlas_pubkey::Pubkey;
/// use atlas_sdk::{
///     message::Message,
...
///     #   lamports: 1,
///     #   data: vec![0],
///     #   owner: atlas_sdk::system_program::ID,
///     #   executable: false,
///     # });
///     let nonce_account = client.get_account(nonce_account_pubkey)?;
///     let nonce_data = atlas_rpc_client_nonce_utils::data_from_account(&nonce_account)?;
...
///
/// [rent exemption]: https://atlas.com/docs/core/accounts#rent-exemption
///
...
#[cfg(test)]
mod tests {
    use {super::*, atlas_sysvar_id::SysvarId};
    ...
    #[test]
    fn test_constants() {
        // Ensure that the constants are in sync with the atlas program.
        assert_eq!(
            RECENT_BLOCKHASHES_ID,
            atlas_sysvar::recent_blockhashes::RecentBlockhashes::id(),
        );

        // Ensure that the constants are in sync with the atlas rent.
        assert_eq!(RENT_ID, atlas_sysvar::rent::Rent::id());
    }
