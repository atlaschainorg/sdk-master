...
//! [secp256r1 native program](https://docs.atlas.com/developing/runtime-facilities/programs#secp256r1-program)
//!
...
pub use atlas_sdk_ids::secp256r1_program::{check_id, id, ID};
...
#[cfg(all(not(target_arch = "wasm32"), not(target_os = "atlas")))]
mod target_arch {
    use {
