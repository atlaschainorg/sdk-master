...
use atlas_frozen_abi_macro::AbiExample;
use {
    crate::{
...
/// A Atlas transaction message (v0).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`atlas_rpc_client`], [`atlas_account`], and [`anyhow`] crates.
    ///
    /// [`atlas_rpc_client`]: https://docs.rs/atlas-rpc-client
    /// [`atlas_account`]: https://docs.rs/atlas-account
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use atlas_example_mocks::{
    /// #     atlas_rpc_client,
    /// #     atlas_account,
    /// #     atlas_transaction,
    /// #     atlas_signer,
    ...
    /// use anyhow::Result;
    /// use atlas_address_lookup_table_interface::state::{AddressLookupTable, LookupTableMeta};
    /// use atlas_instruction::{AccountMeta, Instruction};
    /// use atlas_keypair::Keypair;
    /// use atlas_message::{AddressLookupTableAccount, VersionedMessage, v0};
    /// use atlas_address::Address;
    /// use atlas_rpc_client::rpc_client::RpcClient;
    /// use atlas_signer::Signer;
    /// use atlas_transaction::versioned::VersionedTransaction;
    ///
    ...
    ///     #   owner: atlas_address_lookup_table_interface::program::id(),
    ///     #   executable: false,
    ///     # });
...
#[cfg(test)]
mod tests {
    use {super::*, crate::VersionedMessage, atlas_instruction::AccountMeta};
