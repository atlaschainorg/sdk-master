...
#[cfg_attr(target_os = "atlas", allow(dead_code))]
...
mod tests {
    use {
        super::*, bitflags::bitflags, atlas_instruction::AccountMeta,
        atlas_sdk_ids::sysvar::recent_blockhashes,
        atlas_system_interface::instruction::advance_nonce_account,
    };

    static_assertions::const_assert_eq!(
        NONCED_TX_MARKER_IX_INDEX,
        atlas_nonce::NONCED_TX_MARKER_IX_INDEX as usize
    );
