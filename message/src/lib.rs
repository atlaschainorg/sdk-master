...
//!
//! [`Instruction`]: https://docs.rs/atlas-instruction/latest/atlas_instruction/struct.Instruction.html
//!
//! In Atlas, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/atlas-sdk/latest/atlas-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://atlas.com/docs/core/transactions#recent-blockhash
//!
...
//! version as of Atlas 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! Despite living in the `atlas-program` crate, there is no way to access the
//! runtime's messages from within a Atlas program, and only the legacy message
//! types continue to be exposed to Atlas programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.atlaslabs.com/consensus/synchronization
