...
//!
//! [sv]: https://docs.atlaslabs.com/runtime/sysvars#slothashes
//!
//! The sysvar ID is declared in [`atlas_program::sysvar::slot_hashes`].
//!
//! [`atlas_program::sysvar::slot_hashes`]: https://docs.rs/atlas-program/latest/atlas_program/sysvar/slot_hashes/index.html
...
#[cfg(test)]
mod tests {
    use {super::*, atlas_sha256_hasher::hash};
