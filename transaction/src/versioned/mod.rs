...
#[cfg(feature = "bincode")]
use atlas_signer::{signers::Signers, SignerError};
use {
    crate::Transaction,
    atlas_message::{inline_nonce::is_advance_nonce_instruction_data, VersionedMessage},
...
impl VersionedTransaction {
    ...
    pub fn verify_and_hash_message(
        &self,
    ) -> atlas_transaction_error::TransactionResult<atlas_hash::Hash> {
        ...
        {
            Err(atlas_transaction_error::TransactionError::SignatureFailure)
        } else {
...
mod tests {
    use {
        ...
        atlas_message::Message as LegacyMessage,
        atlas_pubkey::Pubkey,
        atlas_signer::Signer,
