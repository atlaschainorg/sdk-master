...
/// ```ignore
/// use atlas_package_metadata::package_metadata;
///
/// pub fn main() {
...
pub use atlas_package_metadata_macro::package_metadata;
/// Re-export atlas_pubkey::declare_id for easy usage within the macro
pub use atlas_pubkey::declare_id;
...
///
/// ```ignore
/// declare_id_with_package_metadata!("atlas.program-id");
/// ```
///
/// This program id behaves exactly as if the developer had written:
///
/// ```
/// atlas_pubkey::declare_id!("MyProgram1111111111111111111111111111111111");
/// ```
///
