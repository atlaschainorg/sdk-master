...
//! [cpi]: https://atlas.com/docs/core/cpi
//! [`atlas_program::program`]: https://docs.rs/atlas-program/latest/atlas_program/program/

use {
    atlas_account_info::AccountInfo, atlas_instruction::Instruction,
    atlas_program_error::ProgramResult, atlas_pubkey::Pubkey,
};
#[cfg(target_os = "atlas")]
pub mod syscalls;
...
/// the called program.
///
/// [entrypoint!]: https://docs.rs/atlas-entrypoint/latest/atlas_entrypoint/macro.entrypoint.html
///
...
///
/// [`ProgramError`]: https://docs.rs/atlas-program-error/latest/atlas_program_error/enum.ProgramError.html
/// [`ProgramError::AccountBorrowFailed`]: https://docs.rs/atlas-program-error/latest/atlas_program_error/enum.ProgramError.html#variant.AccountBorrowFailed
///
/// # Examples
///
...
/// use atlas_sdk_ids::system_program;
/// use atlas_system_interface::instruction as system_instruction;
///
...
///
/// [pda]: https://atlas.com/docs/core/cpi#program-derived-addresses
/// [`Pubkey::find_program_address`]: https://docs.rs/atlas-pubkey/latest/atlas_pubkey/struct.Pubkey.html#method.find_program_address
///
...
/// Copied from `atlas_program_entrypoint::SUCCESS`
/// to avoid a `atlas_program_entrypoint` dependency
const _SUCCESS: u64 = 0;
#[cfg(test)]
static_assertions::const_assert_eq!(_SUCCESS, atlas_program_entrypoint::SUCCESS);
...
pub fn invoke_signed_unchecked(
    ...
    {
        let instruction =
            atlas_stable_layout::stable_instruction::StableInstruction::from(instruction.clone());
        let result = unsafe {
            crate::syscalls::atlas_invoke_signed_rust(
...
pub fn set_return_data(data: &[u8]) {
    #[cfg(target_os = "atlas")]
    unsafe {
        crate::syscalls::atlas_set_return_data(data.as_ptr(), data.len() as u64)
    };
}
...
///
/// [rdp]: https://docs.atlaslabs.com/proposals/return-data
pub fn get_return_data() -> Option<(Pubkey, Vec<u8>)> {
    #[cfg(target_os = "atlas")]
    {
        ...
        let size = unsafe {
            crate::syscalls::atlas_get_return_data(
                buf.as_mut_ptr(),
                buf.len() as u64,
                &mut program_id,
            )
